 ...
 */
@WebServlet(name = "FeedBackCarServlet", urlPatterns = {"/FeedBackCarServlet"})
public class FeedBackCarServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            boolean result = dao.feedBack(rating, feedback, historyID);
            System.out.println(historyID + rating + feedback);
            if(result){
